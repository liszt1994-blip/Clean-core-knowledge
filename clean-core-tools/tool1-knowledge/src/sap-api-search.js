  ...
  procurement: [
    {
      ...
      description_en: 'Create, read, update and delete purchase orders. Supports the full purchase order lifecycle including line items, schedule lines and conditions.',
    ...
    },
    {
      ...
      description_en: 'Manage the creation and processing of purchase requisitions, supporting both direct and indirect procurement scenarios.',
    ...
    },
    {
      ...
      description_en: 'Read and manage supplier master data, including addresses, bank accounts and purchasing organization data.',
    ...
    },
    {
      ...
      description_en: 'Manage purchase contracts, supporting contract creation, modification and term management.',
    ...
    },
    {
      ...
      description_en: 'Legacy purchase order interface, superseded by API_PURCHASEORDER_PROCESS_SRV.',
  ...
  sales: [
    {
      ...
      description_en: 'Create and manage sales orders, supporting the complete order-to-cash process.',
    ...
    },
    {
      ...
      description_en: 'Manage customer master data, including sales areas, payment terms and contacts.',
      url: 'https://api.sap.com/api/API_BUSINESS_PARTNER/overview',
      protocol: 'OData V2',
      endpoint: '/sap/opu/odata/sap/API_BUSINESS_PARTNER',
  ...
  finance: [
    {
      ...
      description_en: 'Create and query journal entries, supporting manual and bulk posting.',
    ...
    },
    {
      ...
      description_en: 'Query payment and incoming payment information, supporting accounts payable and accounts receivable processing.',
  ...
  hr: [
    {
      ...
      description_en: 'Read and manage employee master data, including personal information, job and compensation data.',
    ...
    },
    {
      ...
      description_en: 'Manage employee leave requests, approvals and balance queries.',
  ...
  inventory: [
    {
      ...
      description_en: 'Query material stock information, including stock quantities per plant and storage location.',
    ...
    },
    {
      ...
      description_en: 'Manage material master data, supporting creation, modification and query of basic material information and view data.',
...
// Return curated APIs for a domain. When lang starts with 'en', swap the
// Chinese `description` for the English `description_en` so downstream
// consumers (the guide `apis` array, the UI cards) stay in the target
// language. description_en is dropped from the returned objects.
function searchSapApis(domain, extraKeywords = '', top = 8, lang = 'zh') {
  const apis = DOMAIN_APIS[domain] || DOMAIN_APIS['procurement'];
  const wantEn = String(lang || '').toLowerCase().startsWith('en');
  return Promise.resolve(
    apis.slice(0, top).map((api) => {
      const { description_en, ...rest } = api;
      return {
        ...rest,
        description: wantEn ? (description_en || api.description) : api.description,
      };
    })
  );
}
